...
(function ($) {
    ...
    */
    ...
    //=== Brand Carousel ===
    function whatdoCarousel() {
        if ($('.whatdo-items-carousel').length) {
            $('.whatdo-items-carousel').owlCarousel({
                dots: false,
                loop: true,
                margin: 30,
                navText: [
    ...
    function ProductsCarousel() {
        if ($('.product-items-carousel').length) {
            $('.product-items-carousel').owlCarousel({
                dots: false,
                loop: true,
                margin: 30,
                navText: [
    ...
    //=== Brand Carousel ===
    function ProductsMobileCarousel() {
        if ($('.product-items-carousel-mobile').length) {
            $('.product-items-carousel-mobile').owlCarousel({
                dots: false,
                loop: true,
                margin: 30,
                navText: [
    ...
    jQuery(window).on('load', function () {
        (function ($) {
            ...
            $("#btnServices").click(function () {
                $('html,body').animate({
                    scrollTop: $(".highlights-area").offset().top
                },
                    'slow');
            });
            ...
            $("#btnProduct").click(function () {
                $('html,body').animate({
                    scrollTop: $(".brand-area").offset().top
                },
                    'slow');
            });
            ...
            $("#btnPackage").click(function () {
                $('html,body').animate({
                    scrollTop: $(".package-area").offset().top
                },
                    'slow');
            });
            $("#btnContact").click(function () {
                $('html,body').animate({
                    scrollTop: $(".footer-area").offset().top
                },
                    'slow');
            });
